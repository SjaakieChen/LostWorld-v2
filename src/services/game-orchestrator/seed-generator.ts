...
export const WORLD_ITEMS: Item[] = [`
  ...
  const itemExports = items.map(item => {
    ...
    visualDescription: '${item.visualDescription.replace(/'/g, "\\'")}',
    functionalDescription: '${item.functionalDescription?.replace(/'/g, "\\'") || ""}',
...
export const GAME_NPCS: NPC[] = [`
  ...
  const npcExports = npcs.map(npc => {
    ...
    visualDescription: '${npc.visualDescription.replace(/'/g, "\\'")}',
    functionalDescription: '${npc.functionalDescription?.replace(/'/g, "\\'") || ""}',
...
export const GAME_LOCATIONS: Location[] = [`
  ...
  const locationExports = locations.map(location => {
    ...
    visualDescription: '${location.visualDescription.replace(/'/g, "\\'")}',
    functionalDescription: '${location.functionalDescription?.replace(/'/g, "\\'") || ""}',
