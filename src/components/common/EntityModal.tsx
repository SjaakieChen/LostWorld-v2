...
const EntityModal = ({ entity, onClose }: EntityModalProps) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-gray-800 rounded-lg p-6 max-w-2xl w-full mx-4 border-2 border-gray-600"
      ...
      >
        ...
        {/* Image */}
        <div className={`w-full h-64 ${getRarityColor(entity.rarity)} rounded-lg mb-4 flex items-center justify-center`}>
          {entity.image_url ? (
            <img 
